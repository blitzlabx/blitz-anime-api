...
[![Built by](https://img.shields.io/badge/Built_by-Blitz_(blitzlabx)-00f3ff?style=for-the-badge&logo=x&logoColor=white)](https://x.com/blitzlabx)
...
**Powered by [anime-sdk](https://github.com/hexxt-git/anime-sdk)** • Crafted by **Blitz (blitzlabx)**
...
| Role | Credit |
|------|--------|
| **Core SDK** | [anime-sdk](https://github.com/hexxt-git/anime-sdk) by **hexxt-git** |
| **API Design, Downloads, Hardening, Free Public Instance, Neon Docs** | **Blitz (blitzlabx)** |
| Social | [@blitzlabx](https://x.com/blitzlabx) |
